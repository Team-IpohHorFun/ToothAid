...
const migrateVisits = async () => {
  try {
    ...
    // Count visits with old/deprecated fields
    ...
    console.log(`📊 Found ${visitsWithOldFields} visits with deprecated fields (dmft, DMFT, referralFlag, or type)\n`);
    ...
    // Remove old/deprecated fields from all visits
    ...
    console.log(`   - Removed fields: dmft, DMFT, referralFlag, type\n`);
